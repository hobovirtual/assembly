...
Import-Module Az.Aks -RequiredVersion 1.1.2 -Global
Import-Module Az.AnalysisServices -RequiredVersion 1.1.3 -Global
Import-Module Az.ApiManagement -RequiredVersion 2.0.1 -Global
...
Import-Module Az.CognitiveServices -RequiredVersion 1.5.0 -Global
Import-Module Az.Compute -RequiredVersion 4.2.0 -Global
...
Import-Module Az.DataFactory -RequiredVersion 1.8.2 -Global
...
Import-Module Az.FrontDoor -RequiredVersion 1.5.0 -Global
Import-Module Az.Functions -RequiredVersion 1.0.1 -Global
Import-Module Az.HDInsight -RequiredVersion 3.3.0 -Global
...
Import-Module Az.Monitor -RequiredVersion 2.0.1 -Global
Import-Module Az.Network -RequiredVersion 3.1.0 -Global
Import-Module Az.NotificationHubs -RequiredVersion 1.1.1 -Global
Import-Module Az.OperationalInsights -RequiredVersion 2.2.0 -Global
...
Import-Module Az.RecoveryServices -RequiredVersion 2.10.0 -Global
Import-Module Az.RedisCache -RequiredVersion 1.2.1 -Global
Import-Module Az.Relay -RequiredVersion 1.0.3 -Global
Import-Module Az.Resources -RequiredVersion 2.2.0 -Global
...
Import-Module Az.Sql -RequiredVersion 2.8.0 -Global
Import-Module Az.SqlVirtualMachine -RequiredVersion 1.1.0 -Global
Import-Module Az.Storage -RequiredVersion 2.2.0 -Global
...
Import-Module Az.Websites -RequiredVersion 1.10.0 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBcVDCVk6aEUtOo
# N7wr/dv5wD40/TREehSOltkq6j+D2qCCDYUwggYDMIID66ADAgECAhMzAAABiK9S
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBHu
# 1JpuRXprhhKqQlbykykCcAhnN+klJBwZjDuDvFpwMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAe7y3rjTzj8ucOme+Oglt+JZ02MQorSBpIy1Q
# ZJSuyiqz69BFTcGjmyE7qWCs/vSr2oI1owi8Bs9d6Zl2mVLjW4PcFNKD3+S/WJ7w
# a8slGbi6YY7vLvlHVAdrosZpZ0odr7dFmthgJSTR0jj5y3vFyBlTvRfwDRHtzh0D
# cPfwxx7RWb8/yFkFtlG9Qx9J7fz17oowEO1rvRObxyppTITJnTzfCuXJy+vaslUu
# DPinGVkUSHhlNF1i90q66vQE/XDpWabHLoUSb2WMlrYQrbbOf112u4IM/z5ODa4I
# Obcg0kyjOhX324nJlY7sRVaXuXY43c8iclUr0DaNLsWIiUlmTqGCEuUwghLhBgor
# BgEEAYI3AwMBMYIS0TCCEs0GCSqGSIb3DQEHAqCCEr4wghK6AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBMjOjRbCmAFdXRs5MNxxMa5rTqlRoCXOan
# kVyFQv/geQIGXs6I8W9PGBMyMDIwMDYxNzE1MjIzNC41OTlaMASAAgH0oIHQpIHN
...
# b2Z0IFRpbWUtU3RhbXAgUENBIDIwMTAwDQYJKoZIhvcNAQEFBQACBQDilA3SMCIY
# DzIwMjAwNjE3MTEzNDQyWhgPMjAyMDA2MTgxMTM0NDJaMHcwPQYKKwYBBAGEWQoE
# ATEvMC0wCgIFAOKUDdICAQAwCgIBAAICHZ4CAf8wBwIBAAICEaMwCgIFAOKVX1IC
# AQAwNgYKKwYBBAGEWQoEAjEoMCYwDAYKKwYBBAGEWQoDAqAKMAgCAQACAwehIKEK
# MAgCAQACAwGGoDANBgkqhkiG9w0BAQUFAAOBgQAmdd2m0rHX7DcG6Cn3ztwApcTh
# BG1/2RdBltnMaU16q8GydQTtR15QTcY+V8MZtvJEAFLmkUJhvlwiOTA8GJWFqcr3
# EP7jv0TgaryZEGISYSh6Vy+BNUWUBQMjAd/c55cxz584Z7ibNG2PW1LuW0lg1Nx3
# dMhxVSAI2uCxqDBzyjGCAw0wggMJAgEBMIGTMHwxCzAJBgNVBAYTAlVTMRMwEQYD
# VQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNy
# b3NvZnQgQ29ycG9yYXRpb24xJjAkBgNVBAMTHU1pY3Jvc29mdCBUaW1lLVN0YW1w
# IFBDQSAyMDEwAhMzAAABGYy7VAgKXf5lAAAAAAEZMA0GCWCGSAFlAwQCAQUAoIIB
# SjAaBgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIKFK
# 8BGuI5sMk355UpIL5bR1lOQh3FgzXhHWrYhg6u4MMIH6BgsqhkiG9w0BCRACLzGB
...
# ZQAAAAABGTAiBCBpOd8E1giowgp9N+IfWDpn1nZbEJudjHdI+Y5hm5oTqjANBgkq
# hkiG9w0BAQsFAASCAQAFZJig8bDwN6UX6o4Q1/7dsGATq7HZGKKSF6cU6kSqFVAW
# Vlcm7yMP7nZDd2P/IA/8PQA92eAiduoN5g6dKfLDzbUc/EkYZm9hpwWIg63eJk3i
# f0rZO++SrulheGPU66uOrAXHZCEdUl3P48IIFPELIkOF5vhRAPBdCve2ghqY+SJu
# H52IZKoB0pwwv7LjRT5+z+M4x6d2ESF7jM/EDb45P1CV+wgTIU2Nz/tf8K3FbwES
# ctHGxfrIElmnQKefP6NpCs1rUJQpip4nX6yuxIwcVdAMyFtV9AzG0c6mimJC7Xoe
# Zs8MwCcN9ZmGQrOHzUreejn7WHEHYbfD26wmF7Rl
